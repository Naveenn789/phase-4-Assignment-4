...
products.Add(6, new Product() { PName = "Hair Oil", PBrand = "Parachute", PPrice = 200.80, ManufacturingDate = new DateTime(day: 08, month: 02, year: 2022), ExpiryDate = new DateTime(day: 10, month: 12, year: 2025) });
